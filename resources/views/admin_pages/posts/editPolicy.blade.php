...
<div class="container-fluid coupon form_ql">
    <form method="post" class="form-submit" action="{{ route('save.edit.policy', $policy->id)}}"
        enctype="multipart/form-data">
        @csrf
        <div class="col-md-12 mt-4 ">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0"><i class="fa fa-info"></i> Cập nhật chính sách</h5>
                </div>
                <div class="card-body row">
                    <div class="col-12">
                        <div class="form_group">
                            <label>Tiêu dề</label>
                            <input name="tieude" autocomplete='off' class="form_control" value="{{ $policy->tieude}}" />
                        </div>
